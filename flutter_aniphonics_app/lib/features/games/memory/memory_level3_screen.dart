...
class MemoryLevel3Screen extends StatefulWidget {
  const MemoryLevel3Screen({super.key});

  @override
  State<MemoryLevel3Screen> createState() => _MemoryLevel3ScreenState();
}

class _MemoryLevel3ScreenState extends State<MemoryLevel3Screen> {
  ...
  Future<void> _showWinDialog() async {
    ...
    if (!mounted) return;
    await ProgressStore.instance.setMemoryLevelComplete(3);
    if (!mounted) return;
    showDialog<void>(
      context: context,
      builder: (context) {
        ...
        return AlertDialog(
          ...
          title: const Text('Level 3 complete!'),
          content: const Text('You finished all memory levels.'),
          actions: [
            TextButton(
              onPressed: () {
            ...
            TextButton(
              ...
              child: Text('Games', style: TextStyle(color: colors.secondary)),
            ),
          ],
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Memory Level 3'),
        actions: const [
      ...
      body: AppBackground(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Fast match! Try to remember quickly.',
